...
<body>
    ...
    <section class="update-product">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="name" placeholder="entre product name" required class="box" value="<?=$fetch_products['name']; ?>">
            <input type="number" name="price" min="0" placeholder="entre product price" required class="box" value="<?=$fetch_products['price']; ?>">
